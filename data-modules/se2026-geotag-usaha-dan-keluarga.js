...
class SE2026GeotagUsahaDanKeluarga extends BaseDataModule {
  constructor() {
    super({
      id: 'se2026-geotag-usaha-dan-keluarga',
      name: 'SE2026 Geotag Usaha Dan Keluarga',
      type: 'building',
  ...
  toLayerConfig(rawItem, fileType = 'csv') {
    ...
    const popupHtml = `
      <div class="p-2 text-xs min-w-[220px]">
        ...
        <div class="space-y-1 mt-1">
          <div><span class="text-base-content/60 font-medium">No. Bangunan:</span> <span class="font-semibold">${noBangunan}</span></div>
          <div><span class="text-base-content/60 font-medium">Kode Bangunan:</span> <span class="font-semibold">${kode_bang_label}</span></div>
        </div>
        <div class="border-t border-base-300 my-2"></div>
        <div class="space-y-1 mt-1">
          <div><span class="text-base-content/60 font-medium">Sumber:</span> <span class="font-semibold">SE2026 Geotag Usaha Dan Keluarga</span></div>
        </div>
        <div class="border-t border-base-300 my-2"></div>        
    ...
    return {
      ...
      label: noBangunan,
      subcategory: 'SE2026 Geotag Usaha Dan Keluarga',
...
export const se2026GetagAll = new SE2026GeotagUsahaDanKeluarga();
