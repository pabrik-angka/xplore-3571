...
/**
 * Xplore 3571 - Module Manager
 * Dipindahkan dari js/moduleManager.js ke js/core/ sesuai arsitektur DDS-Lite.
 *
 * Tanggung jawab: Registry in-memory untuk semua modul data aktif pada sesi ini.
 * Emit EventBus 'app:modules-changed' setiap kali daftar berubah.
...
/** @private — emit via EventBus (menggantikan document.dispatchEvent) */
function _dispatchChanged() {
  EventBus.emit('app:modules-changed', {
