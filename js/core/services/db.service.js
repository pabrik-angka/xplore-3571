// js/core/services/db.service.js
/**
 * Xplore 3571 - Native IndexedDB Storage Service (0KB Dependency)
 * Repository layer untuk menyimpan dan me-restore dataset tabulasi & layer spasial
 * PWA offline caching.
 *
 * Dipindahkan dari js/db.js ke js/core/services/ sesuai arsitektur DDS-Lite.
 */
...
export const DbService = {
  ...
  async saveDataset(storeName, dataObj) {
    try {
      ...
      console.warn(`[DbService] save error (${storeName}):`, e);
    }
  },
  ...
  async getAllDatasets(storeName) {
    try {
      ...
      console.warn(`[DbService] getAll error (${storeName}):`, e);
      return [];
    }
  },
  ...
  async deleteDataset(storeName, id) {
    try {
      ...
      console.warn(`[DbService] delete error (${storeName}):`, e);
    }
  },
